...
public class Certification extends CreativeWork {
    ...
    public String getCertificationIdentification() { return certificationIdentification; }
    public void setCertificationIdentification(String certificationIdentification) { this.certificationIdentification = certificationIdentification; }
    public CertificationStatusEnumeration getCertificationStatus() { return certificationStatus; }
    public void setCertificationStatus(CertificationStatusEnumeration certificationStatus) { this.certificationStatus = certificationStatus; }
    ...
    public java.time.LocalDate getAuditDate() { return auditDate; }
    public void setAuditDate(java.time.LocalDate auditDate) { this.auditDate = auditDate; }
    ...
    public Organization getIssuedBy() { return issuedBy; }
    public void setIssuedBy(Organization issuedBy) { this.issuedBy = issuedBy; }
    public Rating getCertificationRating() { return certificationRating; }
    public void setCertificationRating(Rating certificationRating) { this.certificationRating = certificationRating; }
