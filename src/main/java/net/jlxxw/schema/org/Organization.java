 ...
 */
    ...
    public List<AbstractSchema> getFounder() { return founder; }
    public void setFounder(List<AbstractSchema> founder) { this.founder = founder; }
    ...
    public Certification getCompanyRegistration() { return companyRegistration; }
    public void setCompanyRegistration(Certification companyRegistration) { this.companyRegistration = companyRegistration; }
    ...
    public String getIso6523Code() { return iso6523Code; }
    public void setIso6523Code(String iso6523Code) { this.iso6523Code = iso6523Code; }
    ...
    public List<AbstractSchema> getMembers() { return members; }
    public void setMembers(List<AbstractSchema> members) { this.members = members; }
    public Demand getSeeks() { return seeks; }
    public void setSeeks(Demand seeks) { this.seeks = seeks; }
    public List<AbstractSchema> getServiceArea() { return serviceArea; }
    public void setServiceArea(List<AbstractSchema> serviceArea) { this.serviceArea = serviceArea; }
    ...
    public NonprofitType getNonprofitStatus() { return nonprofitStatus; }
    public void setNonprofitStatus(NonprofitType nonprofitStatus) { this.nonprofitStatus = nonprofitStatus; }
    public List<AbstractSchema> getMember() { return member; }
    public void setMember(List<AbstractSchema> member) { this.member = member; }
    ...
    public MemberProgram getHasMemberProgram() { return hasMemberProgram; }
    public void setHasMemberProgram(MemberProgram hasMemberProgram) { this.hasMemberProgram = hasMemberProgram; }
    public Person getFounders() { return founders; }
    public void setFounders(Person founders) { this.founders = founders; }
    public Person getLegalRepresentative() { return legalRepresentative; }
    public void setLegalRepresentative(Person legalRepresentative) { this.legalRepresentative = legalRepresentative; }
    public PostalAddress getLegalAddress() { return legalAddress; }
    public void setLegalAddress(PostalAddress legalAddress) { this.legalAddress = legalAddress; }
    ...
    public QuantitativeValue getNumberOfEmployees() { return numberOfEmployees; }
    public void setNumberOfEmployees(QuantitativeValue numberOfEmployees) { this.numberOfEmployees = numberOfEmployees; }
    public Place getFoundingLocation() { return foundingLocation; }
    public void setFoundingLocation(Place foundingLocation) { this.foundingLocation = foundingLocation; }
    ...
    public java.time.LocalDate getDissolutionDate() { return dissolutionDate; }
    public void setDissolutionDate(java.time.LocalDate dissolutionDate) { this.dissolutionDate = dissolutionDate; }
    public java.time.LocalDate getFoundingDate() { return foundingDate; }
    public void setFoundingDate(java.time.LocalDate foundingDate) { this.foundingDate = foundingDate; }
    ...
    public Organization getSubOrganization() { return subOrganization; }
    public void setSubOrganization(Organization subOrganization) { this.subOrganization = subOrganization; }
