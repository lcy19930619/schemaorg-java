...
public class SuperficialAnatomy extends MedicalEntity {
    ...
    public List<AbstractSchema> getRelatedAnatomy() { return relatedAnatomy; }
    public void setRelatedAnatomy(List<AbstractSchema> relatedAnatomy) { this.relatedAnatomy = relatedAnatomy; }
