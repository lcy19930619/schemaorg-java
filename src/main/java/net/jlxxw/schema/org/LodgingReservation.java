...
public class LodgingReservation extends Reservation {
    ...
    public String getLodgingUnitType() { return lodgingUnitType; }
    public void setLodgingUnitType(String lodgingUnitType) { this.lodgingUnitType = lodgingUnitType; }
    ...
    public String getLodgingUnitDescription() { return lodgingUnitDescription; }
    public void setLodgingUnitDescription(String lodgingUnitDescription) { this.lodgingUnitDescription = lodgingUnitDescription; }
}