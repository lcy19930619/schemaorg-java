...
public class DrugStrength extends MedicalIntangible {
    ...
    public void setStrengthUnit(String strengthUnit) { this.strengthUnit = strengthUnit; }
    ...
    public void setStrengthValue(Double strengthValue) { this.strengthValue = strengthValue; }
    ...
    public AdministrativeArea getAvailableIn() { return availableIn; }
    public void setAvailableIn(AdministrativeArea availableIn) { this.availableIn = availableIn; }
}