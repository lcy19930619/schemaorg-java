...
public class InfectiousDisease extends MedicalCondition {
    ...
    public AbstractSchema getInfectiousAgentClass() { return infectiousAgentClass; }
    public void setInfectiousAgentClass(AbstractSchema infectiousAgentClass) { this.infectiousAgentClass = infectiousAgentClass; }
    public String getInfectiousAgent() { return infectiousAgent; }
    public void setInfectiousAgent(String infectiousAgent) { this.infectiousAgent = infectiousAgent; }
