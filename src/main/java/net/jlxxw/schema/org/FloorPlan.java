...
Typical unit code(s): ROM for room or C62 for no unit. The type of room can be put in the unitText property of the QuantitativeValue. */
    ...
    public QuantitativeValue getNumberOfAccommodationUnits() { return numberOfAccommodationUnits; }
    public void setNumberOfAccommodationUnits(QuantitativeValue numberOfAccommodationUnits) { this.numberOfAccommodationUnits = numberOfAccommodationUnits; }
    ...
    public QuantitativeValue getNumberOfAvailableAccommodationUnits() { return numberOfAvailableAccommodationUnits; }
    public void setNumberOfAvailableAccommodationUnits(QuantitativeValue numberOfAvailableAccommodationUnits) { this.numberOfAvailableAccommodationUnits = numberOfAvailableAccommodationUnits; }
    ...
    public Accommodation getIsPlanForApartment() { return isPlanForApartment; }
    public void setIsPlanForApartment(Accommodation isPlanForApartment) { this.isPlanForApartment = isPlanForApartment; }
