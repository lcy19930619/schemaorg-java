...
public class Blog extends CreativeWork {
    ...
    public BlogPosting getBlogPosts() { return blogPosts; }
    public void setBlogPosts(BlogPosting blogPosts) { this.blogPosts = blogPosts; }
    public BlogPosting getBlogPost() { return blogPost; }
    public void setBlogPost(BlogPosting blogPost) { this.blogPost = blogPost; }
