...
public class BroadcastEvent extends PublicationEvent {
    ...
    public Event getBroadcastOfEvent() { return broadcastOfEvent; }
    public void setBroadcastOfEvent(Event broadcastOfEvent) { this.broadcastOfEvent = broadcastOfEvent; }
    public Boolean getIsLiveBroadcast() { return isLiveBroadcast; }
    public void setIsLiveBroadcast(Boolean isLiveBroadcast) { this.isLiveBroadcast = isLiveBroadcast; }
}