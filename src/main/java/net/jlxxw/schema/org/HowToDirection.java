...
public class HowToDirection extends CreativeWork {
    ...
    public String getBeforeMedia() { return beforeMedia; }
    public void setBeforeMedia(String beforeMedia) { this.beforeMedia = beforeMedia; }
    public Duration getPerformTime() { return performTime; }
    public void setPerformTime(Duration performTime) { this.performTime = performTime; }
    public String getDuringMedia() { return duringMedia; }
    public void setDuringMedia(String duringMedia) { this.duringMedia = duringMedia; }
    public Duration getPrepTime() { return prepTime; }
    public void setPrepTime(Duration prepTime) { this.prepTime = prepTime; }
    public String getAfterMedia() { return afterMedia; }
    public void setAfterMedia(String afterMedia) { this.afterMedia = afterMedia; }
}