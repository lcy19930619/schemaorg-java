...
public class Ticket extends Intangible {
    ...
    public java.time.LocalDateTime getDateIssued() { return dateIssued; }
    public void setDateIssued(java.time.LocalDateTime dateIssued) { this.dateIssued = dateIssued; }
    ...
    public Seat getTicketedSeat() { return ticketedSeat; }
    public void setTicketedSeat(Seat ticketedSeat) { this.ticketedSeat = ticketedSeat; }
}