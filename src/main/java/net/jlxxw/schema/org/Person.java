...
public class Person extends AbstractSchema {
    ...
    public List<Place> getWorkLocation() {
        return workLocation;
    }

    public void setWorkLocation(List<Place> workLocation) {
    ...
    public List<Place> getHomeLocation() {
        return homeLocation;
    }

    public void setHomeLocation(List<Place> homeLocation) {
    ...
    public List<MonetaryAmount> getNetWorth() {
        return netWorth;
    }

    public void setNetWorth(List<MonetaryAmount> netWorth) {
    ...
    public List<AbstractSchema> getAlumniOf() {
        return alumniOf;
    }

    public void setAlumniOf(List<AbstractSchema> alumniOf) {
