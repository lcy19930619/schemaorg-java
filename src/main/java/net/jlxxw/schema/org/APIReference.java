...
public class APIReference extends TechArticle {
    ...
    public String getProgrammingModel() { return programmingModel; }
    public void setProgrammingModel(String programmingModel) { this.programmingModel = programmingModel; }
    public String getExecutableLibraryName() { return executableLibraryName; }
    public void setExecutableLibraryName(String executableLibraryName) { this.executableLibraryName = executableLibraryName; }
    ...
    public void setAssemblyVersion(String assemblyVersion) { this.assemblyVersion = assemblyVersion; }
}