...
public class MedicalProcedure extends MedicalEntity {
    ...
    public MedicalProcedureType getProcedureType() { return procedureType; }
    public void setProcedureType(MedicalProcedureType procedureType) { this.procedureType = procedureType; }
    ...
    public String getHowPerformed() { return howPerformed; }
    public void setHowPerformed(String howPerformed) { this.howPerformed = howPerformed; }
