...
Note: for historical reasons, any textual label and formal code provided as a literal may be assumed to be from O*NET-SOC. */
    ...
    public AdministrativeArea getOccupationLocation() { return occupationLocation; }
    public void setOccupationLocation(AdministrativeArea occupationLocation) { this.occupationLocation = occupationLocation; }
