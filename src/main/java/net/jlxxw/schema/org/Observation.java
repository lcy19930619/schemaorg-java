...
If there are several [[variableMeasured]] properties recorded for some given data object, use a [[PropertyValue]] for each [[variableMeasured]] and attach the corresponding [[measurementTechnique]]. The value can also be from an enumeration, organized as a [[MeasurementMetholdEnumeration]]. */
    ...
    public StatisticalVariable getMeasurementDenominator() { return measurementDenominator; }
    public void setMeasurementDenominator(StatisticalVariable measurementDenominator) { this.measurementDenominator = measurementDenominator; }
    public Enumeration getMeasurementQualifier() { return measurementQualifier; }
    public void setMeasurementQualifier(Enumeration measurementQualifier) { this.measurementQualifier = measurementQualifier; }
    ...
    public QuantitativeValue getMarginOfError() { return marginOfError; }
    public void setMarginOfError(QuantitativeValue marginOfError) { this.marginOfError = marginOfError; }
    public String getVariableMeasured() { return variableMeasured; }
    public void setVariableMeasured(String variableMeasured) { this.variableMeasured = variableMeasured; }
    public java.time.LocalDateTime getObservationDate() { return observationDate; }
    public void setObservationDate(java.time.LocalDateTime observationDate) { this.observationDate = observationDate; }
    ...
    public Property getMeasuredProperty() { return measuredProperty; }
    public void setMeasuredProperty(Property measuredProperty) { this.measuredProperty = measuredProperty; }
    public List<AbstractSchema> getObservationAbout() { return observationAbout; }
    public void setObservationAbout(List<AbstractSchema> observationAbout) { this.observationAbout = observationAbout; }
}