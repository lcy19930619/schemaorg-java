...
public class MedicalOrganization extends Organization {
    ...
    public Boolean getIsAcceptingNewPatients() { return isAcceptingNewPatients; }
    public void setIsAcceptingNewPatients(Boolean isAcceptingNewPatients) { this.isAcceptingNewPatients = isAcceptingNewPatients; }
}