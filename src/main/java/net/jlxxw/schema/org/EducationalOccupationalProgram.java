...
public class EducationalOccupationalProgram extends Intangible {
    ...
    public Integer getTypicalCreditsPerTerm() {
        return typicalCreditsPerTerm;
    }
    ...
    public String getFinancialAidEligible() {
        return financialAidEligible;
    }

    public void setFinancialAidEligible(String financialAidEligible) {
        this.financialAidEligible = financialAidEligible;
    }

    public AbstractSchema getHasCourse() {
        return hasCourse;
    }

    public void setHasCourse(AbstractSchema hasCourse) {
    ...
    public java.time.LocalDate getApplicationStartDate() {
        return applicationStartDate;
    }

    public void setApplicationStartDate(java.time.LocalDate applicationStartDate) {
        this.applicationStartDate = applicationStartDate;
    }

    public Double getTermsPerYear() {
        return termsPerYear;
    }

    public void setTermsPerYear(Double termsPerYear) {
    ...
    public String getProgramPrerequisites() {
        return programPrerequisites;
    }

    public void setProgramPrerequisites(String programPrerequisites) {
    ...
    public void setOccupationalCredentialAwarded(String occupationalCredentialAwarded) {
    ...
    public String getEducationalProgramMode() {
        return educationalProgramMode;
    }

    public void setEducationalProgramMode(String educationalProgramMode) {
