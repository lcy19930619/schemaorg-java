...
Use Text for incentives that are limited based on other criteria, for example if an incentive is only available to recipients making 120% of the median poverty income in their area. */
    ...
    public Organization getEligibleWithSupplier() { return eligibleWithSupplier; }
    public void setEligibleWithSupplier(Organization eligibleWithSupplier) { this.eligibleWithSupplier = eligibleWithSupplier; }
    ...
    public IncentiveQualifiedExpenseType getQualifiedExpense() { return qualifiedExpense; }
    public void setQualifiedExpense(IncentiveQualifiedExpenseType qualifiedExpense) { this.qualifiedExpense = qualifiedExpense; }
    public List<AbstractSchema> getIncentiveAmount() { return incentiveAmount; }
    public void setIncentiveAmount(List<AbstractSchema> incentiveAmount) { this.incentiveAmount = incentiveAmount; }
    public List<AbstractSchema> getIncentivizedItem() { return incentivizedItem; }
    public void setIncentivizedItem(List<AbstractSchema> incentivizedItem) { this.incentivizedItem = incentivizedItem; }
    ...
    public MonetaryAmount getPurchasePriceLimit() { return purchasePriceLimit; }
    public void setPurchasePriceLimit(MonetaryAmount purchasePriceLimit) { this.purchasePriceLimit = purchasePriceLimit; }
}