...
public class PronounceableText extends Text {
    ...
    public String getSpeechToTextMarkup() { return speechToTextMarkup; }
    public void setSpeechToTextMarkup(String speechToTextMarkup) { this.speechToTextMarkup = speechToTextMarkup; }
    public String getInLanguage() { return inLanguage; }
    public void setInLanguage(String inLanguage) { this.inLanguage = inLanguage; }
    public String getPhoneticText() { return phoneticText; }
    public void setPhoneticText(String phoneticText) { this.phoneticText = phoneticText; }
