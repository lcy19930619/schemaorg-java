...
public class DietarySupplement extends Product {
    ...
    public String getProprietaryName() { return proprietaryName; }
    public void setProprietaryName(String proprietaryName) { this.proprietaryName = proprietaryName; }
    ...
    public String getSafetyConsideration() { return safetyConsideration; }
    public void setSafetyConsideration(String safetyConsideration) { this.safetyConsideration = safetyConsideration; }
    ...
    public RecommendedDoseSchedule getRecommendedIntake() { return recommendedIntake; }
    public void setRecommendedIntake(RecommendedDoseSchedule recommendedIntake) { this.recommendedIntake = recommendedIntake; }
    public Boolean getIsProprietary() { return isProprietary; }
    public void setIsProprietary(Boolean isProprietary) { this.isProprietary = isProprietary; }
    public String getNonProprietaryName() { return nonProprietaryName; }
    public void setNonProprietaryName(String nonProprietaryName) { this.nonProprietaryName = nonProprietaryName; }
}