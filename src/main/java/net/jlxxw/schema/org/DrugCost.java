...
public class DrugCost extends MedicalEntity {
    ...
    public String getCostOrigin() { return costOrigin; }
    public void setCostOrigin(String costOrigin) { this.costOrigin = costOrigin; }
    public DrugCostCategory getCostCategory() { return costCategory; }
    public void setCostCategory(DrugCostCategory costCategory) { this.costCategory = costCategory; }
