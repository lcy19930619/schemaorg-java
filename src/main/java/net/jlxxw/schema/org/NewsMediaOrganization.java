...
public class NewsMediaOrganization extends Organization {
    ...
    public String getMissionCoveragePrioritiesPolicy() {
        return missionCoveragePrioritiesPolicy;
    }

    public void setMissionCoveragePrioritiesPolicy(String missionCoveragePrioritiesPolicy) {
    ...
    public String getNoBylinesPolicy() {
        return noBylinesPolicy;
    }

    public void setNoBylinesPolicy(String noBylinesPolicy) {
        this.noBylinesPolicy = noBylinesPolicy;
    }

    public String getVerificationFactCheckingPolicy() {
        return verificationFactCheckingPolicy;
    }

    public void setVerificationFactCheckingPolicy(String verificationFactCheckingPolicy) {
