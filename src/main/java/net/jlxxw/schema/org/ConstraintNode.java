...
public class ConstraintNode extends Intangible {
    ...
    public Integer getNumConstraints() { return numConstraints; }
    public void setNumConstraints(Integer numConstraints) { this.numConstraints = numConstraints; }
    public String getConstraintProperty() { return constraintProperty; }
    public void setConstraintProperty(String constraintProperty) { this.constraintProperty = constraintProperty; }
}