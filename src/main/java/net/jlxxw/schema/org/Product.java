...
The property values can be expressed either as unstructured text (repeated as necessary), or if ordered, as a list (in which case the most positive is at the beginning of the list). */
    ...
    public List<AbstractSchema> getIsRelatedTo() { return isRelatedTo; }
    public void setIsRelatedTo(List<AbstractSchema> isRelatedTo) { this.isRelatedTo = isRelatedTo; }
    public String getProductID() { return productID; }
    public void setProductID(String productID) { this.productID = productID; }
    public String getNegativeNotes() { return negativeNotes; }
    public void setNegativeNotes(String negativeNotes) { this.negativeNotes = negativeNotes; }
    ...
    public String getNsn() { return nsn; }
    public void setNsn(String nsn) { this.nsn = nsn; }
    ...
    public Product getIsAccessoryOrSparePartFor() { return isAccessoryOrSparePartFor; }
    public void setIsAccessoryOrSparePartFor(Product isAccessoryOrSparePartFor) { this.isAccessoryOrSparePartFor = isAccessoryOrSparePartFor; }
    public List<AbstractSchema> getIsVariantOf() { return isVariantOf; }
    public void setIsVariantOf(List<AbstractSchema> isVariantOf) { this.isVariantOf = isVariantOf; }
    ...
    public Product getIsConsumableFor() { return isConsumableFor; }
    public void setIsConsumableFor(Product isConsumableFor) { this.isConsumableFor = isConsumableFor; }
    ...
    public String getCountryOfLastProcessing() { return countryOfLastProcessing; }
    public void setCountryOfLastProcessing(String countryOfLastProcessing) { this.countryOfLastProcessing = countryOfLastProcessing; }
    ...
    public String getCountryOfAssembly() { return countryOfAssembly; }
    public void setCountryOfAssembly(String countryOfAssembly) { this.countryOfAssembly = countryOfAssembly; }
    ...
    public String getInProductGroupWithID() { return inProductGroupWithID; }
    public void setInProductGroupWithID(String inProductGroupWithID) { this.inProductGroupWithID = inProductGroupWithID; }
    ...
    public EnergyConsumptionDetails getHasEnergyConsumptionDetails() { return hasEnergyConsumptionDetails; }
    public void setHasEnergyConsumptionDetails(EnergyConsumptionDetails hasEnergyConsumptionDetails) { this.hasEnergyConsumptionDetails = hasEnergyConsumptionDetails; }
    ...
    public String getPositiveNotes() { return positiveNotes; }
    public void setPositiveNotes(String positiveNotes) { this.positiveNotes = positiveNotes; }
    ...
    public List<AbstractSchema> getIsSimilarTo() { return isSimilarTo; }
    public void setIsSimilarTo(List<AbstractSchema> isSimilarTo) { this.isSimilarTo = isSimilarTo; }
