...
public class PropertyValueSpecification extends Intangible {
    ...
    public Double getValueMaxLength() { return valueMaxLength; }
    public void setValueMaxLength(Double valueMaxLength) { this.valueMaxLength = valueMaxLength; }
    ...
    public Double getValueMinLength() { return valueMinLength; }
    public void setValueMinLength(Double valueMinLength) { this.valueMinLength = valueMinLength; }
    public Boolean getReadonlyValue() { return readonlyValue; }
    public void setReadonlyValue(Boolean readonlyValue) { this.readonlyValue = readonlyValue; }
