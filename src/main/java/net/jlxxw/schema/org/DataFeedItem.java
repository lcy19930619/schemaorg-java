...
public class DataFeedItem extends Intangible {
    ...
    public Thing getItem() { return item; }
    public void setItem(Thing item) { this.item = item; }
    ...
    public java.time.LocalDate getDateDeleted() { return dateDeleted; }
    public void setDateDeleted(java.time.LocalDate dateDeleted) { this.dateDeleted = dateDeleted; }
