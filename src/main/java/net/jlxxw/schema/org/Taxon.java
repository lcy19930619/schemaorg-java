...
public class Taxon extends AbstractSchema {
    ...
    public String getChildTaxon() { return childTaxon; }
    public void setChildTaxon(String childTaxon) { this.childTaxon = childTaxon; }
    public String getParentTaxon() { return parentTaxon; }
    public void setParentTaxon(String parentTaxon) { this.parentTaxon = parentTaxon; }
