...
public class Trip extends Intangible {
    ...
    public Trip getPartOfTrip() { return partOfTrip; }
    public void setPartOfTrip(Trip partOfTrip) { this.partOfTrip = partOfTrip; }
    public Trip getSubTrip() { return subTrip; }
    public void setSubTrip(Trip subTrip) { this.subTrip = subTrip; }
    public Place getTripOrigin() { return tripOrigin; }
    public void setTripOrigin(Place tripOrigin) { this.tripOrigin = tripOrigin; }
    ...
    public List<AbstractSchema> getItinerary() { return itinerary; }
    public void setItinerary(List<AbstractSchema> itinerary) { this.itinerary = itinerary; }
}