...
public class Order extends Intangible {
    ...
    public Offer getAcceptedOffer() { return acceptedOffer; }
    public void setAcceptedOffer(Offer acceptedOffer) { this.acceptedOffer = acceptedOffer; }
    ...
    public ParcelDelivery getOrderDelivery() { return orderDelivery; }
    public void setOrderDelivery(ParcelDelivery orderDelivery) { this.orderDelivery = orderDelivery; }
    ...
    public List<AbstractSchema> getMerchant() { return merchant; }
    public void setMerchant(List<AbstractSchema> merchant) { this.merchant = merchant; }
    public java.time.LocalDateTime getPaymentDue() { return paymentDue; }
    public void setPaymentDue(java.time.LocalDateTime paymentDue) { this.paymentDue = paymentDue; }
    public AbstractSchema getOrderStatus() { return orderStatus; }
    public void setOrderStatus(AbstractSchema orderStatus) { this.orderStatus = orderStatus; }
    ...
    public Invoice getPartOfInvoice() { return partOfInvoice; }
    public void setPartOfInvoice(Invoice partOfInvoice) { this.partOfInvoice = partOfInvoice; }
    public String getConfirmationNumber() { return confirmationNumber; }
    public void setConfirmationNumber(String confirmationNumber) { this.confirmationNumber = confirmationNumber; }
    public List<AbstractSchema> getOrderedItem() { return orderedItem; }
    public void setOrderedItem(List<AbstractSchema> orderedItem) { this.orderedItem = orderedItem; }
    public List<AbstractSchema> getCustomer() { return customer; }
    public void setCustomer(List<AbstractSchema> customer) { this.customer = customer; }
    ...
    public void setBillingAddress(PostalAddress billingAddress) { this.billingAddress = billingAddress; }
