...
public class CourseInstance extends Event {
    ...
    public String getCourseWorkload() { return courseWorkload; }
    public void setCourseWorkload(String courseWorkload) { this.courseWorkload = courseWorkload; }
    ...
    public Schedule getCourseSchedule() { return courseSchedule; }
    public void setCourseSchedule(Schedule courseSchedule) { this.courseSchedule = courseSchedule; }
}