...
public class RentalCarReservation extends Reservation {
    ...
    public Place getDropoffLocation() { return dropoffLocation; }
    public void setDropoffLocation(Place dropoffLocation) { this.dropoffLocation = dropoffLocation; }
    ...
    public java.time.LocalDateTime getDropoffTime() { return dropoffTime; }
    public void setDropoffTime(java.time.LocalDateTime dropoffTime) { this.dropoffTime = dropoffTime; }
}