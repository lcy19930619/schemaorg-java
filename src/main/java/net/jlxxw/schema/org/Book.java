...
public class Book extends CreativeWork {
    ...
    public Boolean getAbridged() { return abridged; }
    public void setAbridged(Boolean abridged) { this.abridged = abridged; }
    public BookFormatType getBookFormat() { return bookFormat; }
    public void setBookFormat(BookFormatType bookFormat) { this.bookFormat = bookFormat; }
    public Person getIllustrator() { return illustrator; }
    public void setIllustrator(Person illustrator) { this.illustrator = illustrator; }
}