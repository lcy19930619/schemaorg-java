...
public class ProgramMembership extends Intangible {
    ...
    public Double getMembershipPointsEarned() { return membershipPointsEarned; }
    public void setMembershipPointsEarned(Double membershipPointsEarned) { this.membershipPointsEarned = membershipPointsEarned; }
    ...
    public MemberProgram getProgram() { return program; }
    public void setProgram(MemberProgram program) { this.program = program; }
    ...
    public Organization getHostingOrganization() { return hostingOrganization; }
    public void setHostingOrganization(Organization hostingOrganization) { this.hostingOrganization = hostingOrganization; }
