...
public class CreativeWork extends AbstractSchema {
    ...
    public List<AbstractSchema> getCopyrightHolder() {
        return copyrightHolder;
    }

    public void setCopyrightHolder(List<AbstractSchema> copyrightHolder) {
    ...
    public List<AbstractSchema> getMaintainer() {
        return maintainer;
    }

    public void setMaintainer(List<AbstractSchema> maintainer) {
    ...
    public String getEditEIDR() {
        return editEIDR;
    }

    public void setEditEIDR(String editEIDR) {
    ...
    public String getAcquireLicensePage() {
        return acquireLicensePage;
    }

    public void setAcquireLicensePage(String acquireLicensePage) {
    ...
    public String getMaterialExtent() {
        return materialExtent;
    }

    public void setMaterialExtent(String materialExtent) {
        this.materialExtent = materialExtent;
    }

    public String getSdLicense() {
        return sdLicense;
    }

    public void setSdLicense(String sdLicense) {
    ...
    public void setDigitalSourceType(IPTCDigitalSourceEnumeration digitalSourceType) {
    ...
    public List<AbstractSchema> getProducer() {
        return producer;
    }

    public void setProducer(List<AbstractSchema> producer) {
    ...
    public java.time.LocalDate getSdDatePublished() {
        return sdDatePublished;
    }

    public void setSdDatePublished(java.time.LocalDate sdDatePublished) {
    ...
    public List<AbstractSchema> getVideo() {
        return video;
    }

    public void setVideo(List<AbstractSchema> video) {
        this.video = video;
    }
    ...
    public java.time.LocalDateTime getContentReferenceTime() {
        return contentReferenceTime;
    }

    public void setContentReferenceTime(java.time.LocalDateTime contentReferenceTime) {
    ...
    public List<AbstractSchema> getSdPublisher() {
        return sdPublisher;
    }

    public void setSdPublisher(List<AbstractSchema> sdPublisher) {
    ...
    public void setConditionsOfAccess(String conditionsOfAccess) {
    ...
    public List<AbstractSchema> getAudio() {
        return audio;
    }

    public void setAudio(List<AbstractSchema> audio) {
        this.audio = audio;
    }
