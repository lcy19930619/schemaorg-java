...
public class MolecularEntity extends BioChemEntity {
    ...
    public DefinedTerm getChemicalRole() { return chemicalRole; }
    public void setChemicalRole(DefinedTerm chemicalRole) { this.chemicalRole = chemicalRole; }
    public String getSmiles() { return smiles; }
    public void setSmiles(String smiles) { this.smiles = smiles; }
    public String getMonoisotopicMolecularWeight() { return monoisotopicMolecularWeight; }
    public void setMonoisotopicMolecularWeight(String monoisotopicMolecularWeight) { this.monoisotopicMolecularWeight = monoisotopicMolecularWeight; }
    public String getIupacName() { return iupacName; }
    public void setIupacName(String iupacName) { this.iupacName = iupacName; }
    public DefinedTerm getPotentialUse() { return potentialUse; }
    public void setPotentialUse(DefinedTerm potentialUse) { this.potentialUse = potentialUse; }
