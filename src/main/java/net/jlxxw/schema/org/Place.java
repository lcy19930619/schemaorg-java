...
public class Place extends AbstractSchema {
    ...
    public List<AbstractSchema> getPhotos() {
        return photos;
    }

    public void setPhotos(List<AbstractSchema> photos) {
        this.photos = photos;
    }
    ...
    public List<AbstractSchema> getGeo() {
        return geo;
    }

    public void setGeo(List<AbstractSchema> geo) {
        this.geo = geo;
    }
    ...
    public AbstractSchema getOpeningHoursSpecification() {
        return openingHoursSpecification;
    }

    public void setOpeningHoursSpecification(AbstractSchema openingHoursSpecification) {
    ...
    public List<AbstractSchema> getPhoto() {
        return photo;
    }

    public void setPhoto(List<AbstractSchema> photo) {
        this.photo = photo;
    }
    ...
    public AbstractSchema getSpecialOpeningHoursSpecification() {
        return specialOpeningHoursSpecification;
    }

    public void setSpecialOpeningHoursSpecification(AbstractSchema specialOpeningHoursSpecification) {
