...
public class Event extends AbstractSchema {
    ...
    public EventAttendanceModeEnumeration getEventAttendanceMode() { return eventAttendanceMode; }
    public void setEventAttendanceMode(EventAttendanceModeEnumeration eventAttendanceMode) { this.eventAttendanceMode = eventAttendanceMode; }
    ...
    public Integer getMaximumPhysicalAttendeeCapacity() { return maximumPhysicalAttendeeCapacity; }
    public void setMaximumPhysicalAttendeeCapacity(Integer maximumPhysicalAttendeeCapacity) { this.maximumPhysicalAttendeeCapacity = maximumPhysicalAttendeeCapacity; }
    public EventStatusType getEventStatus() { return eventStatus; }
    public void setEventStatus(EventStatusType eventStatus) { this.eventStatus = eventStatus; }
    ...
    public CreativeWork getWorkPerformed() { return workPerformed; }
    public void setWorkPerformed(CreativeWork workPerformed) { this.workPerformed = workPerformed; }
    public List<AbstractSchema> getOffers() { return offers; }
    public void setOffers(List<AbstractSchema> offers) { this.offers = offers; }
    public List<AbstractSchema> getAttendees() { return attendees; }
    public void setAttendees(List<AbstractSchema> attendees) { this.attendees = attendees; }
    public List<AbstractSchema> getAttendee() { return attendee; }
    public void setAttendee(List<AbstractSchema> attendee) { this.attendee = attendee; }
    public String getLocation() { return location; }
    public void setLocation(String location) { this.location = location; }
    public List<AbstractSchema> getOrganizer() { return organizer; }
    public void setOrganizer(List<AbstractSchema> organizer) { this.organizer = organizer; }
    ...
    public java.time.LocalDate getPreviousStartDate() { return previousStartDate; }
    public void setPreviousStartDate(java.time.LocalDate previousStartDate) { this.previousStartDate = previousStartDate; }
    ...
    public Integer getMaximumVirtualAttendeeCapacity() { return maximumVirtualAttendeeCapacity; }
    public void setMaximumVirtualAttendeeCapacity(Integer maximumVirtualAttendeeCapacity) { this.maximumVirtualAttendeeCapacity = maximumVirtualAttendeeCapacity; }
    public List<AbstractSchema> getPerformer() { return performer; }
    public void setPerformer(List<AbstractSchema> performer) { this.performer = performer; }
    public CreativeWork getRecordedIn() { return recordedIn; }
    public void setRecordedIn(CreativeWork recordedIn) { this.recordedIn = recordedIn; }
    ...
    public java.time.LocalDateTime getDoorTime() { return doorTime; }
    public void setDoorTime(java.time.LocalDateTime doorTime) { this.doorTime = doorTime; }
    ...
    public List<AbstractSchema> getPerformers() { return performers; }
    public void setPerformers(List<AbstractSchema> performers) { this.performers = performers; }
    public Event getSubEvent() { return subEvent; }
    public void setSubEvent(Event subEvent) { this.subEvent = subEvent; }
    public Event getSubEvents() { return subEvents; }
    public void setSubEvents(Event subEvents) { this.subEvents = subEvents; }
    ...
    public CreativeWork getWorkFeatured() { return workFeatured; }
    public void setWorkFeatured(CreativeWork workFeatured) { this.workFeatured = workFeatured; }
    ...
    public Schedule getEventSchedule() { return eventSchedule; }
    public void setEventSchedule(Schedule eventSchedule) { this.eventSchedule = eventSchedule; }
    public List<AbstractSchema> getComposer() { return composer; }
    public void setComposer(List<AbstractSchema> composer) { this.composer = composer; }
    ...
    public Event getSuperEvent() { return superEvent; }
    public void setSuperEvent(Event superEvent) { this.superEvent = superEvent; }
    public String getKeywords() { return keywords; }
    public void setKeywords(String keywords) { this.keywords = keywords; }
    public java.time.LocalDate getEndDate() { return endDate; }
    public void setEndDate(java.time.LocalDate endDate) { this.endDate = endDate; }
    public Integer getRemainingAttendeeCapacity() { return remainingAttendeeCapacity; }
    public void setRemainingAttendeeCapacity(Integer remainingAttendeeCapacity) { this.remainingAttendeeCapacity = remainingAttendeeCapacity; }
}