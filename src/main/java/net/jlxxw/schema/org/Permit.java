...
public class Permit extends Intangible {
    ...
    public Audience getPermitAudience() { return permitAudience; }
    public void setPermitAudience(Audience permitAudience) { this.permitAudience = permitAudience; }
    ...
    public Service getIssuedThrough() { return issuedThrough; }
    public void setIssuedThrough(Service issuedThrough) { this.issuedThrough = issuedThrough; }
}