...
public class ProductGroup extends Product {
    ...
    public String getVariesBy() { return variesBy; }
    public void setVariesBy(String variesBy) { this.variesBy = variesBy; }
    public Product getHasVariant() { return hasVariant; }
    public void setHasVariant(Product hasVariant) { this.hasVariant = hasVariant; }
}