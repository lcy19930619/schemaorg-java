...
In the context of [[ShippingService]], use the [[ServicePeriod]] format, that contains the same information in a structured form, with cut-off time, business days and duration. */
    ...
    public AbstractSchema getShippingConditions() { return shippingConditions; }
    public void setShippingConditions(AbstractSchema shippingConditions) { this.shippingConditions = shippingConditions; }
    ...
    public FulfillmentTypeEnumeration getFulfillmentType() { return fulfillmentType; }
    public void setFulfillmentType(FulfillmentTypeEnumeration fulfillmentType) { this.fulfillmentType = fulfillmentType; }
