...
public class BioChemEntity extends AbstractSchema {
    ...
    public String getIsLocatedInSubcellularLocation() {
        return isLocatedInSubcellularLocation;
    }

    public void setIsLocatedInSubcellularLocation(String isLocatedInSubcellularLocation) {
    ...
    public String getTaxonomicRange() {
        return taxonomicRange;
    }

    public void setTaxonomicRange(String taxonomicRange) {
