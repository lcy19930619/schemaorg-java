...
public class MemberProgramTier extends Intangible {
    ...
    public String getHasTierRequirement() { return hasTierRequirement; }
    public void setHasTierRequirement(String hasTierRequirement) { this.hasTierRequirement = hasTierRequirement; }
    public TierBenefitEnumeration getHasTierBenefit() { return hasTierBenefit; }
    public void setHasTierBenefit(TierBenefitEnumeration hasTierBenefit) { this.hasTierBenefit = hasTierBenefit; }
    public MemberProgram getIsTierOf() { return isTierOf; }
    public void setIsTierOf(MemberProgram isTierOf) { this.isTierOf = isTierOf; }
}