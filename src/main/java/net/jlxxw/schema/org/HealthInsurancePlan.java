...
public class HealthInsurancePlan extends Intangible {
    ...
    public String getHealthPlanDrugOption() {
        return healthPlanDrugOption;
    }

    public void setHealthPlanDrugOption(String healthPlanDrugOption) {
    ...
    public String getHealthPlanMarketingUrl() {
        return healthPlanMarketingUrl;
    }

    public void setHealthPlanMarketingUrl(String healthPlanMarketingUrl) {
    ...
    public String getUsesHealthPlanIdStandard() {
        return usesHealthPlanIdStandard;
    }

    public void setUsesHealthPlanIdStandard(String usesHealthPlanIdStandard) {
