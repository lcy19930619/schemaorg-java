...
public class ShippingRateSettings extends StructuredValue {
    ...
    public Boolean getIsUnlabelledFallback() { return isUnlabelledFallback; }
    public void setIsUnlabelledFallback(Boolean isUnlabelledFallback) { this.isUnlabelledFallback = isUnlabelledFallback; }
    public List<AbstractSchema> getFreeShippingThreshold() { return freeShippingThreshold; }
    public void setFreeShippingThreshold(List<AbstractSchema> freeShippingThreshold) { this.freeShippingThreshold = freeShippingThreshold; }
    public Double getOrderPercentage() { return orderPercentage; }
    public void setOrderPercentage(Double orderPercentage) { this.orderPercentage = orderPercentage; }
