...
public class SoftwareApplication extends CreativeWork {
    ...
    public String getProcessorRequirements() { return processorRequirements; }
    public void setProcessorRequirements(String processorRequirements) { this.processorRequirements = processorRequirements; }
    public String getSoftwareRequirements() { return softwareRequirements; }
    public void setSoftwareRequirements(String softwareRequirements) { this.softwareRequirements = softwareRequirements; }
    ...
    public SoftwareApplication getSoftwareAddOn() { return softwareAddOn; }
    public void setSoftwareAddOn(SoftwareApplication softwareAddOn) { this.softwareAddOn = softwareAddOn; }
    public String getApplicationSuite() { return applicationSuite; }
    public void setApplicationSuite(String applicationSuite) { this.applicationSuite = applicationSuite; }
    public String getScreenshot() { return screenshot; }
    public void setScreenshot(String screenshot) { this.screenshot = screenshot; }
    public String getAvailableOnDevice() { return availableOnDevice; }
    public void setAvailableOnDevice(String availableOnDevice) { this.availableOnDevice = availableOnDevice; }
    public CreativeWork getSoftwareHelp() { return softwareHelp; }
    public void setSoftwareHelp(CreativeWork softwareHelp) { this.softwareHelp = softwareHelp; }
    ...
    public String getCountriesNotSupported() { return countriesNotSupported; }
    public void setCountriesNotSupported(String countriesNotSupported) { this.countriesNotSupported = countriesNotSupported; }
    ...
    public String getApplicationSubCategory() { return applicationSubCategory; }
    public void setApplicationSubCategory(String applicationSubCategory) { this.applicationSubCategory = applicationSubCategory; }
    ...
    public String getCountriesSupported() { return countriesSupported; }
    public void setCountriesSupported(String countriesSupported) { this.countriesSupported = countriesSupported; }
    ...
    public DataFeed getSupportingData() { return supportingData; }
    public void setSupportingData(DataFeed supportingData) { this.supportingData = supportingData; }
