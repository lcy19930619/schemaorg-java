...
public class DefinedRegion extends StructuredValue {
    ...
    public PostalCodeRangeSpecification getPostalCodeRange() { return postalCodeRange; }
    public void setPostalCodeRange(PostalCodeRangeSpecification postalCodeRange) { this.postalCodeRange = postalCodeRange; }
