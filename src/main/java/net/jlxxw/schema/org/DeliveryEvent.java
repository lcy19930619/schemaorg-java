...
public class DeliveryEvent extends Event {
    ...
    public java.time.LocalDateTime getAvailableThrough() { return availableThrough; }
    public void setAvailableThrough(java.time.LocalDateTime availableThrough) { this.availableThrough = availableThrough; }
