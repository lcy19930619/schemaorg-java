...
public class ArchiveComponentJsonldTest {
    @Test
    public void testJsonldRoundTrip() throws Exception {
        ...
        InputStream is = getClass().getClassLoader().getResourceAsStream("ArchiveComponent.jsonld");
        assertNotNull(is, "ArchiveComponent.jsonld resource not found");
