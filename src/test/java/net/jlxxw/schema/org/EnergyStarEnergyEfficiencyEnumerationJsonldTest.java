...
public class EnergyStarEnergyEfficiencyEnumerationJsonldTest {
    @Test
    public void testJsonldRoundTrip() throws Exception {
        ...
        InputStream is = getClass().getClassLoader().getResourceAsStream("EnergyStarEnergyEfficiencyEnumeration.jsonld");
        assertNotNull(is, "EnergyStarEnergyEfficiencyEnumeration.jsonld resource not found");
        String jsonld = new Scanner(is, StandardCharsets.UTF_8.name()).useDelimiter("\\A").next();

        // Deserialize to Java object
        EnergyStarEnergyEfficiencyEnumeration acc = mapper.readValue(jsonld, EnergyStarEnergyEfficiencyEnumeration.class);
        assertNotNull(acc);
    ...
    public void testDefaultIdAndType() {
        EnergyStarEnergyEfficiencyEnumeration obj = new EnergyStarEnergyEfficiencyEnumeration();
        assertEquals("schema:EnergyStarEnergyEfficiencyEnumeration", obj.getId());
